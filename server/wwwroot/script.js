...
class MyClass {
    ...
    uploadRom(event) {
        ...
        reader.onload = function (e) {
            ...
            console.log('uploadServer value: ' + uploadServer);
            if (uploadServer) {
                console.log("Uploading to server...");
                var oReq = new XMLHttpRequest();
                oReq.open("POST", this.rivetsData.settings.CLOUDSAVEURL + "/UploadGame?name=" + file + "&password=" + this.rivetsData.password, true);
    ...
    loadCloud(){
        ...
        var oReq = new XMLHttpRequest();
        oReq.open("GET", this.rivetsData.settings.CLOUDSAVEURL + "/LoadSaveState?name=" + this.rom_name + '.n64wasm' +
