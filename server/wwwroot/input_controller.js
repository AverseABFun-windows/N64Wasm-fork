...
class KeyMappings {
    ...
    constructor() {
        ...
        this.Mapping_Action_Start = "enter";
        this.Mapping_Action_CUP = "w";
        this.Mapping_Action_CDOWN = "s";
        this.Mapping_Action_CLEFT = "a";
        this.Mapping_Action_CRIGHT = "d";
        this.Mapping_Action_Analog_Up = "up";
        this.Mapping_Action_Analog_Down = "down";
        this.Mapping_Action_Analog_Left = "left";
        this.Mapping_Action_Analog_Right = "right";
        this.Mapping_Action_Z = "z";
        this.Mapping_Action_L = "q";
        this.Mapping_Action_R = "e";
        this.Mapping_Action_B = "c";
        this.Mapping_Action_A = "x";
        this.Mapping_Menu = "space";
